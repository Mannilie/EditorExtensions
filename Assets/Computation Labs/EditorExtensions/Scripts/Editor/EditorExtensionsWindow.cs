using ComputationLabs.Common;
using UnityEditor;
using UnityEngine;
namespace ComputationLabs
{
    public class EditorExtensionsWindow : EditorWindow
    {
        ...
        [MenuItem("Window/Computation Labs/Editor Extensions")]
        ...
        private void Update()
        {
            if (m_sceneView != null)
            {
                ...
                euler.y += m_rotationSpeedY * EditorTime.deltaTime;
                ...
                if (m_controlZoom)
                {
                    ...
                    if (m_waypoint1 != null && m_waypoint2 != null)
                    {
                        if (m_zooming)
                        {
                            m_zoomTime += m_zoomSpeed * EditorTime.deltaTime;
